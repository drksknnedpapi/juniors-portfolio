        ...
        <div className="text-center py-40 hero mb-32">
          ...
          <section className="mx-10">
            <h1 className="text-pink-200  text-5xl md:text-6xl lg:text-7xl mt-9 tracking-tight hero-header">
              Emmanuel Junior <br /><span className="text-pink-50">Ameku-Doe</span></h1>

            {/* LARGE SCREEN */}
            <p className="text-gray-400 mt-6 tracking-wide mx-auto max-w-lg hidden md:block">
              I'm an <span className="text-gray-200 font-semibold">IT security specialist</span> based in <span className="font-bold bg-gradient-to-r from-red-500 via-yellow-500 to-green-500 bg-clip-text text-transparent">
                Accra, Ghana,</span> specializing in developing strategies for   <span className="text-gray-200 font-semibold">protecting devices </span>
              and <span className="text-gray-200 font-semibold">systems </span>within an organization from cyberattacks
            </p>
